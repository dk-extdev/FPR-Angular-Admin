...
export class ClientUserComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.clientUserService
            ...
            .subscribe(
                (res: HttpResponse<IClientUser[]>) => this.paginateClientUsers(res.body, res.headers),
    ...
    trackId(index: number, item: IClientUser) {
        return item.id;
    }

    registerChangeInClientUsers() {
        this.eventSubscriber = this.eventManager.subscribe('clientUserListModification', response => this.loadAll());
    }
    ...
    private paginateClientUsers(data: IClientUser[], headers: HttpHeaders) {
