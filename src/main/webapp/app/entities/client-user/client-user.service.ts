...
type EntityResponseType = HttpResponse<IClientUser>;
type EntityArrayResponseType = HttpResponse<IClientUser[]>;
...
export class ClientUserService {
    ...
    update(clientUser: IClientUser): Observable<EntityResponseType> {
        return this.http.put<IClientUser>(this.resourceUrl, clientUser, { observe: 'response' });
    }
