...
import com.fpr360.repository.AuthorityRepository;
...
import com.fpr360.service.dto.PasswordChangeDTO;
import com.fpr360.service.dto.UserDTO;
import com.fpr360.web.rest.errors.ExceptionTranslator;
import com.fpr360.web.rest.vm.KeyAndPasswordVM;
...
public class AccountResourceIntTest {
    ...
    public void testGetExistingAccount() throws Exception {
        ...
        restUserMockMvc.perform(get("/api/account")
            ...
            .andExpect(jsonPath("$.userType").value("GURU"))
    ...
    public void testRegisterValid() throws Exception {
        ...
        validUser.setUserType(UserType.GURU);
        validUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DATA_ENTRY_OPERATOR));
    ...
    public void testRegisterInvalidLogin() throws Exception {
        ...
        invalidUser.setUserType(UserType.GURU);
        invalidUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DATA_ENTRY_OPERATOR));
    ...
    public void testRegisterDuplicateLogin() throws Exception {
        ...
        firstUser.setUserType(UserType.GURU);
        firstUser.setAuthorities(Collections.singleton(AuthoritiesConstants.DATA_ENTRY_OPERATOR));
        ...
        secondUser.setUserType(UserType.GURU);
    ...
    public void testRegisterDuplicateEmail() throws Exception {
        ...
        userWithUpperCaseEmail.setUserType(UserType.GURU);
    ...
    public void testRegisterAdminIsIgnored() throws Exception {
        ...
        assertThat(userDup.get().getAuthorities()).hasSize(1)
            .containsExactly(authorityRepository.findById(AuthoritiesConstants.DATA_ENTRY_OPERATOR).get());
    }
    ...
    public void testSaveAccount() throws Exception {
        ...
        userDTO.setUserType(UserType.GURU);
