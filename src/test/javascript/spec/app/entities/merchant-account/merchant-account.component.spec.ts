...
import { MerchantAccountComponent } from 'app/entities/merchant-account/merchant-account.component';
...
describe('Component Tests', () => {
    describe('MerchantAccount Management Component', () => {
        let comp: MerchantAccountComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(MerchantAccountComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.merchantAccounts[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
