...
import { GuruClientComponent } from 'app/entities/guru-client/guru-client.component';
...
describe('Component Tests', () => {
    describe('GuruClient Management Component', () => {
        let comp: GuruClientComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(GuruClientComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.guruClients[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
