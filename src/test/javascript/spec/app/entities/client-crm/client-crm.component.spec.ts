...
import { ClientCrmComponent } from 'app/entities/client-crm/client-crm.component';
...
describe('Component Tests', () => {
    describe('ClientCrm Management Component', () => {
        let comp: ClientCrmComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(ClientCrmComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.clientCrms[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
