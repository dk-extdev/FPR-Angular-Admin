...
describe('Service Tests', () => {
    describe('ClientUser Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(ClientUserService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/client-users';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ClientUser', () => {
                service.create(new ClientUser(null)).subscribe(received => {
            ...
            it('should update a ClientUser', () => {
                service.update(new ClientUser(123)).subscribe(received => {
