    ...
    describe('ServiceProvider Service', () => {
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/service-providers';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });

            it('should create a ServiceProvider', () => {
                service.create(new ServiceProvider(null)).subscribe(received => {
            ...
            it('should update a ServiceProvider', () => {
                service.update(new ServiceProvider(123)).subscribe(received => {
            ...
            it('should return a ServiceProvider', () => {
            ...
            it('should return a list of ServiceProvider', () => {
                ...
                const req = httpMock.expectOne({ method: 'GET' });
                req.flush([new ServiceProvider(123)]);
            });
